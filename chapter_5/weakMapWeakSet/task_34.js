...
Теперь вопрос стоит так: какую структуру данных вы бы предложили использовать для хранения информации 
о том, когда сообщение было прочитано?
...
let readMap = new WeakMap(); //создаем объект WeakMap

readMap.set(messages[0], new Date(2017, 1, 1)); //добавить ключ-значение: объект[0] и объект дата